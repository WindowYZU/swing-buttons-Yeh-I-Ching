    ...
    public static void main(String[] args) throws Exception {
        ...
        ActionListener listener=new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                JOptionPane.showMessageDialog(null, ""+radio1.isSelected()+","+radio2.isSelected()+", "+checkBox.isSelected()+", "+toggleButton.isSelected()); //To change body of generated methods, choose Tools | Templates.
            }
        };
